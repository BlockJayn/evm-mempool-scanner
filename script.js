...
var scanMempool = function () {
    ...
    provider._websocket.on("error", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    provider._websocket.on("close", function (code) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            console.log("Connection lost with code ".concat(code, "! Attempting reconnect in 3s..."));
